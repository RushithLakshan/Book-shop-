...
<head>
   ...
   <link rel="stylesheet" href="styles/admin_users_style.css">
	...
	<div class="usersDiv">
		...
		<table class="usersTab" >
			...
			while($row = $result->fetch_assoc()){
				...
				<tr>
					<td>Item details: $row[name]</td>
				</tr>
				<tr>
					<td>Item details: $row[email]</td>
				</tr>
				<tr>
					<td>Item details: $row[user_type]</td>
				</tr>	
				<tr>
					<td><a  href='admin_delete_user.php?id=$row[id]'><input class='delete-btn' type='button' value='Delete User'></a></td>
				</tr>
				<tr>
					<td><hr></td>
				</tr>				
